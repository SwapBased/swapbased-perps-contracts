...
import "./interfaces/IOrderBookOld.sol";


contract OrderBookOld is ReentrancyGuard, IOrderBookOld {
    ...
    function createSwapOrder(
        ...
        require(_path[0] != usdb && _path[_path.length - 1] != usdb, "OB: invalid token");
