...
contract Vault is ReentrancyGuard, IVault {
    ...
    event Swap(bytes32 indexed account, address indexed tokenIn, address indexed tokenOut, uint256 amountIn, uint256 amountOut);
    ...
    function swap(
        ...
        emit Swap( bytes32(uint256(uint160(_receiver))), _tokenIn, _tokenOut, amountIn, amountOutAfterFees);
    ...
    function getRedemptionAmount(address _token, uint256 _usdbAmount) public view override returns (uint256) {
    ...
    function getTargetUsdbAmount(address _token) public view override returns (uint256) {
